...
<body class="bg-gray-100 min-h-screen font-sans p-8">
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
        <<<<<<< Updated upstream <div class="flex justify-between items-center mb-6">
    ...
    <div class="grid grid-cols-2 gap-4 mb-6">
        <div class="bg-blue-100 p-4 rounded">
            ...
            <<<<<<< Updated upstream <p>Total Students: {{ $studentCount }}</p>
        </div>
    ...
    <div class="flex flex-wrap gap-4">
        <<<<<<< Updated upstream <a href="{{ route('students.index') }}"
